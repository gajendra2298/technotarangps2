...
export const projectsApi = {
  ...
  approveMilestone: (id: string, milestoneIndex: number, transactionHash: string) => 
    api.post(`/projects/${id}/milestones/${milestoneIndex}/approve`, { transactionHash }),
...
export const bidsApi = {
  create: (data: { projectId: string; proposedAmount: number; message: string }) => api.post('/bids', data),
...
export const authApi = {
  sync: (data: { token: string; email: string; clerkId: string }) => api.post('/auth/sync', data),
